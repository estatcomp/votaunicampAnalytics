...
# Introdução
  ...
  A partir desse site, o objetivo do trabalho é analisar a opinião dos alunos de graduação da Unicamp, verificar se realmente o número de alunos a favor da greve é maior que o número de alunos contrarios a ela. Além do mais, podemos fazer comparações entre os diversos institutos, ver quais são a favor, contra ou neutros em relação a greve. 
