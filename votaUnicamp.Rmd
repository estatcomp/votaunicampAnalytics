...
Desejamos verificar a proporção de alunos contrários à greve estudantil. Além disso, também temos o intuito de estudar o comportamento da classe, como por exemplo, se existe uma relação entre a área de estudo e o voto. Assim, podemos caracterizar o perfil do aluno como favorável ou contrário à mobilização.

#Metodologia

## Formatação de Dados

Extraímos do site uma tabela com o número de votos de cada curso (sim, não ou abstenho), incluindo cursos da Unicamp campus Limeira e Piracicaba.
