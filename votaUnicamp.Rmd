---
title: "Pojeto Final ME524 - Vota Unicamp!"
...
Queremos mostrar que a proporção de "sim" não excede 50% do total de votos válidos

```{r teste de hipotese para proporçao}
...
Rejeita-se a hipótese nula, pois o p-valor é muito pequeno.
