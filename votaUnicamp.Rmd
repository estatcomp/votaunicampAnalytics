...
Diante de todos os dados análisados,interpretação dos gráficos e o que vivenciamos durante todo período de greve em nossa universidade, acreditamos que, apesar do número de votos presentes no site "votaunicamp" ter sido baixo, podemos considerar que a amostra se aproxima da realidade. Notamos que os alunos de exatas e biológicas, em sua maioria, tendem a serem contrários a greve. Enquanto os alunos de humanas e artes são a favor, isso se deve ao fato desses cursos estarem diretamente ligados às questões sociais.
A decisão a respeito da greve é feita através de assembléias, que são reuniões organizadas pelo centro acadêmico de cada instituto, os quais são formados, majoritariamente por alunos favoráveis ao movimento. Devido as atividades e cronogramas acadêmicos a serem cumpridos, muitos dos estudantes contrários a greve não abrem mão de seus afazeres para comparecerem a tais reuniões que acabam contando com um número reduzido de alunos que, em sua maioria, votam a favor.
Vale ressaltar também que pelo motivo da pesquisa não ser anônima, pode causar possível receio dos alunos que são favoráveis a greve, pelo fato de precisar identificar o seu primeiro nome, seu curso e seu RG, fazendo que sejam expostos aos docentes que terão acesso a essa pesquisa.Portanto os dados podem ser tendenciosos. 
Até o momento mais da metade dos institutos da UNICAMP estão em greve o que revela um contraste com os resultados da pesquisa, e, além disso evidencia um fato que, por motivos como os relatados acima, tem sido fortemente questionado por docentes e estudantes: a não representatividade das assembléias.
Sabemos que a posição de cada estudante mediante a greve é muito importante para chegar a uma conclusão mais justa. Com isso, a votação por assembleias e online são essenciais para obtermos um resultado certeiro.