...
Levando em consideração que os institutos em sua grande parte possuem cursos em mesma área de estudo, e, além disso, que a greve é votada e decidida em assembléias do instituto como um todo, é interessante analisar a proporção de votos para cada um deles.  
...
Então o resultado final estimado foi que a proporção de alunos contrários à greve corresponde à `r round(res_boot$t0,2)*100`%.  
...
Como podemos ver, o gráfico acima mostra a tendência de votos por institutos em relação aos vetores que representam as opções. Nota-se que existem alguns institutos aglomerados, o que indica semelhança de proporções e, por isso, faz-se necessário um estudo aprofundado do assunto.  
